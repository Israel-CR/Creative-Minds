...
const addResp = (e) => {
  if (opcRespuesta.value !== "") {
    infoActivity.value.respuestas.push(opcRespuesta.value);
  }
  opcRespuesta.value = "";
};
...
const AddActivity = async () => {
  await classStore
    .AddActivity(idClase, infoActivity.value)
    .then(() => {
...
<template>
  <div class="modal-box bg-base-200">
    ...
    <div v-if="currentStep === 2">
      ...
      <div v-if="infoActivity.tipo === 'Opcion Multiple'" className="py-2 ">
        <label for="" className="label font-bold text-lg">Agregar Opcion</label>
      ...
      <div className="py-2 ">
        <label for="" className="label font-bold text-lg">Respuesta correcta</label>
        <select
    ...
    <div v-if="currentStep === 3">
      <div className="py-2 ">
        <label for="" className="label font-bold text-lg"
          >Agregar retroalimentacion</label
        >
        <textarea
          v-model="infoActivity.retroalimentacion"
